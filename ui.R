...
ui <- fluidPage(
    ...
    fluidRow(
        ...
        column(width = 2,
               tags$a(href="https://iieg.gob.mx/ns/",
                      tags$img(id = "iieg",
                               src = "https://iieg.gob.mx/ns/wp-content/uploads/2019/03/sieglogo-copia.png",
                               height =  "120rem",
                               width =  "auto"))
               ),
        
        column(width = 2, offset = 8,
                    tags$a(id = "pp", href="https://iieg.gob.mx/ns/?page_id=14707",
                           "Más información")
                    )
             ),
    #
